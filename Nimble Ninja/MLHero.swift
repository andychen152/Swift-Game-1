...
class MLHero: SKSpriteNode {
    ...
    func loadAppearance(){
        ...
        body = SKSpriteNode(color: UIColor.whiteColor(), size: CGSizeMake(self.frame.size.width, 40.0))
        body.position = CGPointMake(0.0, 2.0)
        addChild(body)
        
        let skinColor = UIColor(red: 238.0/255.0, green: 203.0/255.0, blue: 173.0/255.0, alpha: 1.0)
        ...
        eyebrow.position = CGPointMake(-1, leftEye.size.height/2 + 1)
        leftEye.addChild(eyebrow)
        rightEye.addChild(eyebrow.copy() as! SKSpriteNode)
        
        //making arm
        
        let armColor = UIColor(red: 238.0/255.0, green: 238.0/255.0, blue: 224.0/255.0, alpha: 1.0)
        arm = SKSpriteNode(color: armColor, size: CGSizeMake(8, 10))
        arm.anchorPoint = CGPointMake(0.5, 0.9)
        arm.position = CGPointMake(-7, -10)
        body.addChild(arm)
        
        // making hand
        
        let hand = SKSpriteNode(color: skinColor, size: CGSizeMake(arm.size.width, 3))
